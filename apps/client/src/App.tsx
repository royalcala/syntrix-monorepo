...
import { AppShell, type NavItem, type OrgInfo } from "./components/AppShell";
import { CommandPalette, type SearchResult, type QuickAction } from "./components/CommandPalette";
