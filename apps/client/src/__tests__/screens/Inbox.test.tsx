...
describe("Inbox", () => {
  ...
  it("renders invite list", () => {
    ...
    render(<Inbox invites={invites} onAccept={() => {}} />);
  ...
  it("calls onAccept when accept button clicked", () => {
    ...
    render(<Inbox invites={invites} onAccept={onAccept} />);
    const acceptBtn = screen.getByText(/Aceptar/i) || screen.getByText(/Accept/i);
