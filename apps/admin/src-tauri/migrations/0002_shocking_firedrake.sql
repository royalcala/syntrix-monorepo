...
--> statement-breakpoint
CREATE INDEX `idx_view_definitions_org` ON `view_definitions` (`org_id`);--> statement-breakpoint
ALTER TABLE `admin_devices` ADD `device_type` text DEFAULT 'client' NOT NULL;